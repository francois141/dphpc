...
folder="results/best_thread_combination/"
...
# K = 256
python3 plot_bars_percentile.py --input $input_v100 --output_folder $folder --gpu v100 --K 256 --percentile 0.5
...
# K = 256
# python3 plot_bars_percentile.py --input $input_a100 --output_folder $folder --gpu a100 --K 256 --percentile 0.5
